...
@php
    $classes = Flux::classes()
        ...
        ->add(
            match ($size) {
                'xl' => 'text-3xl [&:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&]:mt-2',
                'lg' => 'text-2xl [&:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&]:mt-2',
                default => 'text-xl [&:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&]:mt-2',
            },
        );
@endphp
