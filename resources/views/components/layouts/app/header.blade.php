...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <flux:sidebar stashable sticky
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group>
                <flux:navlist.item :href="route('cv')" :current="request()->routeIs('cv')" wire:navigate>
                    {{ __('CV') }}
                </flux:navlist.item>
                <flux:navlist.item :href="route('projects')" :current="request()->routeIs('projects')" wire:navigate>
                    {{ __('Projecten') }}
                </flux:navlist.item>
